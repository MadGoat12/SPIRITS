...
class PaginatorElement extends PolymerElement {
  static get template() {
    return html`
      <style>
        :host {
      ...
      <div class="page arrow" on-click="goFirst"><paper-ripple></paper-ripple><<</div>
      <div class="page arrow" on-click="goBack"><paper-ripple></paper-ripple><</div>
      <iron-selector id="selector" style="display: flex;" attr-for-selected="page" selected="{{selectedPage}}">
       <template is="dom-repeat" items="[[pages]]">
      <div page="[[item.page]]" class="page"><paper-ripple></paper-ripple>[[item.page]]</div>
      </template>

      </iron-selector>

      <div class="page arrow" on-click="goForward"><paper-ripple></paper-ripple>></div>
      <div class="page arrow" on-click="goLast"><paper-ripple></paper-ripple>>></div>
